...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="fixed top-4 left-4 z-50 p-2 rounded-lg bg-background-surface border border-border text-text-primary lg:hidden"
      ...
      <aside
        className={`
          fixed top-0 left-0 z-40 h-full w-[260px] bg-background-surface border-r border-border
      ...
      >
        ...
        <div className="px-4 py-4 border-t border-border">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-background-elevated flex items-center justify-center text-xs font-medium text-text-secondary">
              TA
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-text-primary truncate">Tenant Admin</p>
